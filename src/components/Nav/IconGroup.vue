...
import Button from 'primevue/button';
     ...
     <template>
    <div class="inline-flex " style="height:30px; margin-top: -18px;">
        <Button style="height: 40px; width: 40px;" icon="pi pi-moon" class="m-1 p-button-rounded p-button-info p-button-outlined" />
