...
<template>
    ...
    <form @submit.prevent="submitForm" style="height: 100%; display: flex; flex-direction: column;">
        ...
        <div class="grid p-fluid">
            <div class="field col-12 md:col-4 lg:col-4">
                <span class="flex flex-column gap-2 ">
                    <label for="priceFirstHour" style="font-size: small; font-weight: 100; color:lightslategray;"> سعر الساعه الاولى </label>
                ...
                <div class="field col-12 md:col-4 lg:col-4">
                    <span class="flex flex-column gap-2 ">
                        <label for="priceForRemainingHour" style="font-size: small; font-weight: 100; color:lightslategray;"> سعر باقي الساعات </label>
        ...
        <template #footer>
            <Button type="submit" class="p-button-primry" icon="fa-solid fa-plus" label="إضافة"  />
            <Button @click="resetForm" icon="pi pi-refresh" label="مسح" class="p-button-danger"
